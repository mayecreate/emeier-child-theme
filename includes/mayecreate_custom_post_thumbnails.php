...
function wpdocs_theme_setup() {
	...
	add_image_size('projects', 500, 530, true); // (cropped)
	add_image_size('projects-alt', 550, 245, true); // (cropped)
	add_image_size('team', 300, 350, true); // (cropped)
	add_image_size('head', 1920, 600, true); // (cropped)
	add_image_size('slider', 1920, 920, true); // (cropped)
