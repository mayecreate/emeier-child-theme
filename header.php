...
<!-- <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;500&family=Oswald:wght@300;400;500&display=swap" rel="stylesheet"> -->
<link rel="stylesheet" href="https://use.typekit.net/tpr2sdg.css">


<?php wp_head(); ?>
    
 <!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-4FL9PDRD2V"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-4FL9PDRD2V');
</script>   

<meta name="google-site-verification" content="1bP0iuKEhRaw5uH48hX3ZyggevzxJIVhApg9TozoIpg" />

<meta name="msvalidate.01" content="500DB267683942E4EDAADAC110B63DE7" />
...
<?php } elseif (is_home()) { ?>
        <div class="pagehead" id="internalfeatured" style=" max-height: 600px; background-image: url('<?php bloginfo('url'); ?>/wp-content/uploads/2022/06/header_default.jpg')">
            <div class="container">
